...
function PersonalInfoForm({
  ...
  const fields=[
    ...
    {key:'proffession', label:'Profession', icon: BriefcaseBusiness, type:'text', required:true},
      ...
      <div className="flex items-center gap-2">
        ...
        {typeof data.image === "object" && (
          <div className="flex flex-col gap-1 pl-4 text-sm">
            ...
            <label className="text-gray-900 gap-3 cursor-pointer relative inline-flex items-center">
              <input
                type="checkbox"
              ...
              />
              <div className="w-9 h-5 bg-slate-300 rounded-full peer peer-checked:bg-green-600 transitions-colors duration-200"></div>
              <span
