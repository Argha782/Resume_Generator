...
function Features() {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-m-12 mt-40'>
            ...
            <Title title='Generate resume' description='Our streamlined process helps you create a resume in minutes with intelligent AI-powered tools and features.'/>
