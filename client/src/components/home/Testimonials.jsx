            ...
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p>{card.name}</p>
                        <svg className="mt-0.5 fill-indigo-700" width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        ...
        <div id='testimonials' className='flex flex-col items-center my-10 scroll-m-12'>
            ...
            <span className="flex items-center gap-1 text-indigo-600 font-medium">
                <BookUserIcon className='size-4.5 stroke-indigo-700'/>
                Testitmonials
            </span>
            </div>
            <Title title="Tell us your thoughts" description="Check out what our past users have to say about us. We are always looking to improve. If you found this helpful please leave us a positive review."/>
        </div>
