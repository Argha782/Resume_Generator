...
function Footer() {
    return (
        <div>
            <footer className="flex flex-col bg-gradient-to-r from-indigo-800 via-white to-indigo-800 items-center justify-around w-full py-16 text-sm text-gray-800/70 mt-40">
                ...
                <div className="flex items-center gap-4 mt-8 text-indigo-500">
                    <a href="https://www.facebook.com/argha.saha.378" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/saha__argha/" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.linkedin.com/in/argha-saha-80527a208/" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://github.com/Argha782" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="mt-8 text-center">Copyright © 2025 <a href="https://prebuiltui.com">Resume Generator</a>. All rights reservered.</p>
            </footer>
