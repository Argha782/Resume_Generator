    ...
    >
      ...
      <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur text-slate-800 text-sm">
        ...
        <a href="https://prebuiltui.com">
          <img src="/logo.svg" alt="logo" className="h-11 w-autof" />
        </a>
        ...
        <div className="hidden md:block space-x-3">
          <Link to='/app?state=register' className="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 transition text-white rounded-md" hidden={user}>
            Get started
          </Link>
